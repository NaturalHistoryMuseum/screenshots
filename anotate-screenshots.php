...
mysqli_connect("localhost", $databasedetails['devscratchpadseu']['user'], $databasedetails['devscratchpadseu']['password'], TRUE, 2);
mysqli_select_db('devscratchpadseu');
$sites = unserialize(array_pop(mysqli_fetch_object(mysqli_query("SELECT value FROM variable WHERE name = 'scratchpad_sites_list'"))));
